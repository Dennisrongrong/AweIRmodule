# -*- coding: utf-8 -*-
"""
@Time ： 2024/11/25 18:43
@Auth ： 归去来兮
@File ：different_datasets.py
@IDE ：PyCharm
@Motto:花中自幼微风起
"""
...
class TrainSetLoader(Dataset):
    def __init__(self, dataset_dir, dataset_name, patch_size, img_norm_cfg=None):
        ...
        if not os.path.exists(self.dataset_dir + '/img_idx/train_' + dataset_name + '.txt') and os.path.exists(
                self.dataset_dir + '/img_idx/train.txt'):
            shutil.copyfile(self.dataset_dir + '/img_idx/train.txt',
